...
class DeductionAmountScreen extends StatefulWidget {
  const DeductionAmountScreen({super.key});

  @override
  State<DeductionAmountScreen> createState() => _DeductionAmountScreenState();
}

class _DeductionAmountScreenState extends State<DeductionAmountScreen> {
  final List<AdvanceAmountModel> deductionAmtModel = [
    AdvanceAmountModel(
      date: '18/04/2025',
      id: '125',
      name: 'Rohan Kale',
              ...
              ListView.builder(
                ...
                itemBuilder: (context, index) {
                  final currentIndexDateStr =
                      deductionAmtModel.elementAt(index).date;

                  final previousIndexDateStr = deductionAmtModel
                      ...
                      Padding(
                        ...
                        child: GestureDetector(
                          ...
                          child: AdvanceAmountWidget(
                            advanceAmtModel: deductionAmtModel,
                            index: index,
